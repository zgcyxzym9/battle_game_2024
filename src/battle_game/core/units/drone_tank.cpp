...
Drone_Tank::Drone_Tank(GameCore *game_core, uint32_t id, uint32_t player_id)
...
void Drone_Tank::Update() {
  TankMove(3.0f, glm::radians(180.0f));
  TurretRotate();
  Fire();
}

void Drone_Tank::TankMove(float move_speed, float rotate_angular_speed) {
...
bool Drone_Tank::IsHit(glm::vec2 position) const {
...
const char *Drone_Tank::UnitName() const {
  return "Drone Tank";
}

const char *Drone_Tank::Author() const {
  return "15Cu2+";
}
}  // namespace battle_game::unit
